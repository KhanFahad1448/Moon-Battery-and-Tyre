...
function AboutPage() {
  useMeta({ title: "About Moon Battery and Tyre — 27 Years on the Road", description: "From a single Ranchi bay in 1999 to three cities and 1.2 lakh wheels fitted. Meet the team behind Moon Battery and Tyre." });
  ...
  return (
    <>
      ...
      <section className="container mx-auto max-w-3xl px-6 py-20">
        {["Moon Battery and Tyre opened in Ranchi, Jharkhand in 1997 with a single bay and a hand-cranked bead breaker. The founder, a former rally mechanic, had one rule pinned to the wall: never fit a tyre you would not put on your own family's car.","That rule scaled. Today we run 3 bays across 3 cities, fit over 1.2 lakh wheels a year, and still print the manufacturing date code on every single invoice so customers can check the freshness of what they bought.","We invested early in equipment nobody else in the neighbourhood had — touchless tyre changers that never touch an alloy rim, road-force balancers accurate to five grams, and camera-based 3D alignment rigs that hand you a printed before-and-after report.","We also refused things. No commission on upselling. No mystery fitting charge added at the counter. No stock older than six months, ever, even when it costs us margin to send it back.","The result is a workshop that behaves like a showroom: transparent, clean, quick, and staffed by technicians who can tell you exactly why your inner shoulder is wearing faster than your outer one."].map((p, i) => (
